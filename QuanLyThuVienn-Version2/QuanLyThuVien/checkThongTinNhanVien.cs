...
namespace QuanLyThuVien
{
    ...
    {
        public static string check_update_emp(string tenNV, string matKhau, string quyenHan, string diaChi, string chucVu, int tuoi, string sdt)
        {
            ...
            { return ("Không được để trống tên nhân viên"); }
                ...
                if (matKhau.Length - 1 <= 0 || matKhau.Length - 1 <= 0)
